    ...
    <SafeAreaView style={{ flex: 1 }} className="bg-zinc-50 dark:bg-zinc-950">
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20 }}>
        ...
        <VStack className="space-y-5 gap-5">
          {/* Old Password */}
          <Box>
            <Text className="text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-2 ml-1">Mật khẩu hiện tại</Text>
            <Input className="h-14 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm focus:border-yellow-400">
              ...
              <InputSlot className="pr-4" onPress={() => setShowOld(!showOld)}>
                <InputIcon as={showOld ? EyeOff : Eye} className="text-zinc-400 w-5 h-5" />
              </InputSlot>
            </Input>
          </Box>
          ...
          {/* New Password */}
          <Box>
            <Text className="text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-2 ml-1">Mật khẩu mới</Text>
            <Input className="h-14 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm focus:border-yellow-400">
              <InputSlot className="pl-4 pr-2">
                <InputIcon as={Lock} className="text-zinc-500 w-5 h-5" />
              </InputSlot>
              ...
              <InputSlot className="pr-4" onPress={() => setShowNew(!showNew)}>
                <InputIcon as={showNew ? EyeOff : Eye} className="text-zinc-400 w-5 h-5" />
              </InputSlot>
            </Input>
          </Box>
          ...
          {/* Confirm Password */}
          <Box>
            <Text className="text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-2 ml-1">Xác nhận mật khẩu mới</Text>
            <Input className="h-14 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm focus:border-yellow-400">
              <InputSlot className="pl-4 pr-2">
                <InputIcon as={Lock} className="text-zinc-500 w-5 h-5" />
              </InputSlot>
              ...
              <InputSlot className="pr-4" onPress={() => setShowConfirm(!showConfirm)}>
                <InputIcon as={showConfirm ? EyeOff : Eye} className="text-zinc-400 w-5 h-5" />
              </InputSlot>
            </Input>
          </Box>
