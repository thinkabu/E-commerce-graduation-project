              ...
              return (
                ...
                >
                  <HStack className="justify-between items-start mb-3">
                    ...
                    <Box
                      className={`${statusConf.bg} px-2.5 py-1 rounded-lg flex-row items-center space-x-1.5 gap-1.5`}
                    >
                      <Icon
                        as={statusConf.icon}
                        className={`${statusConf.color} w-3 h-3`}
                      />
                      <Text
                        className={`text-[10px] font-black uppercase ${statusConf.color}`}
                      >
                        {statusConf.label}
                      </Text>
                    </Box>
