      ...
      try {
        ...
        if (id) {
          ...
          if (setFormData && productProps.data) {
            ...
            // Convert backend specifications (object) back to specs (array) for the form
            ...
            setFormData({
              ...
              countryOfOrigin: product.countryOfOrigin || "Việt Nam",
              discountPercentage: product.discountPercentage || 0,
              specs,
              variants: product.variants || [],
            });

            const prodCategoryId = product.categoryId?._id || product.categoryId || "";
            const currentCat = catData.find((c: Category) => c._id === prodCategoryId);
            if (currentCat) {
              if (currentCat.parentId) {
                setSelectedParentId(currentCat.parentId);
                setSelectedSubId(currentCat._id);
              } else {
                setSelectedParentId(currentCat._id);
                setSelectedSubId("");
              }
            }
          }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-2 space-y-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label htmlFor="productId">Mã sản phẩm (SKU):</Label>
                        <Input
                          id="productId"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label>Danh mục cha: <span className="text-destructive">*</span></Label>
                        {loadingCategories ? (
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      value={formData.importStatus || "Imported"}
                      onValueChange={(value) =>
                  ...
                  <div>
                    <Label htmlFor="countryOfOrigin">Quốc gia xuất xứ:</Label>
                    <Select
                      value={formData.countryOfOrigin || "Việt Nam"}
                      onValueChange={(value) =>
