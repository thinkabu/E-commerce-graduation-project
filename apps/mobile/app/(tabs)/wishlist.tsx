      ...
      {!isAuthenticated ? (
        <VStack className="flex-1 justify-center items-center px-10">
          <Box className="w-24 h-24 rounded-full bg-zinc-100 dark:bg-zinc-900 items-center justify-center mb-6">
            <Icon
              as={Heart}
              className="text-zinc-300 dark:text-zinc-700 w-12 h-12"
            />
          </Box>
          ...
          >
            <ButtonText className="text-zinc-900 font-bold">
              Đăng nhập ngay
            </ButtonText>
          </Button>
        </VStack>
                ...
                >
                  <Box className="w-full h-40 bg-zinc-50 dark:bg-zinc-800 rounded-2xl mb-3 relative overflow-hidden">
                    ...
                    >
                      <Icon
                        as={Heart}
                        className="text-red-500 fill-red-500 w-4 h-4"
                      />
                    </Pressable>
                    <Image
                  ...
                  <VStack className="space-y-1 gap-1 px-1">
                    <Text
                      className="text-xs text-zinc-800 dark:text-zinc-200 font-medium leading-tight h-8"
                      numberOfLines={2}
                    >
                      {product.name}
                    </Text>
                    <HStack className="justify-between items-center mt-2">
                      ...
                      >
                        <Icon
                          as={ShoppingCart}
                          className="text-zinc-900 w-4 h-4"
                        />
                      </Pressable>
                    </HStack>
                  </VStack>
        ...
        <VStack className="flex-1 justify-center items-center px-10">
          ...
          <Text className="text-sm text-zinc-500 text-center mb-8">
            Hãy thêm những sản phẩm bạn yêu thích vào đây để theo dõi giá và
            khuyến mãi nhé!
          </Text>
          <Button
